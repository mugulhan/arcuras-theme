			...
			return (
				<div
					...
					style={{
						minWidth: '20px',
						textAlign: 'right',
						minHeight: '18.2px' // Match textarea line height (13px font * 1.4 line-height)
					}}
				>
					{number}
				</div>
			...
			>
				...
				<div
					...
					style={{
						...
						fontSize: '13px',
						lineHeight: '18.2px', // 13px * 1.4 = 18.2px - exact match with textarea
						color: '#666',
						userSelect: 'none',
						overflow: 'hidden',
				...
				<textarea
					...
					style={{
						width: '100%',
						padding: '8px 12px 0 12px', // top right bottom left - removed bottom padding
						paddingTop: '8px', // Match line numbers padding
						border: 'none',
						outline: 'none',
						resize: 'vertical',
						fontSize: '13px',
						lineHeight: '18.2px', // 13px * 1.4 = 18.2px - exact match with line numbers
						fontFamily: 'monospace',
						minHeight: `${rows * 18.2 + 8}px`, // rows * lineHeight + top padding only
